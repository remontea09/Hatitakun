...
{
    [SerializeField] public GameObject Cgo_Text;//テキストオブジェクトを入れる変数aをGameObject型で宣言　インスペクター上でTextオブジェクトをアタッチする
    [SerializeField] private TextMeshProUGUI Ct_text;//Text型の変数bを宣言
